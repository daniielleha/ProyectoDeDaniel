...
public class MainActivity extends AppCompatActivity {
    ...
    private void CrearSharedPreferences() {
        SharedPreferences.Editor editor = sharedPreferences.edit(); //activar edicion
